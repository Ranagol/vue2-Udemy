        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                ...
                <transition name="slide" mode="out-in"><!--This is for creating transition animations when changing route. The previous site will fade out, slide out, the next page will slide in, fade in. -->
                    ...
                    <router-view></router-view><!--All the routed components will be loaded here. The router-view is a built in component, it comes with Vue. Vue will load the component that has to be loaded into the <router-view></router-view>. This routerview is unnamed, because this is the default router view, where everything loads -->
                </transition>
